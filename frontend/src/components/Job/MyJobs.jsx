...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          "https://jobhub-backend-xvh8.onrender.com/api/v1/job/getmyjobs",
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(
        `https://jobhub-backend-xvh8.onrender.com/api/v1/job/update/${jobId}`,
        updatedJob,
        {
          withCredentials: true,
        }
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(
        `https://jobhub-backend-xvh8.onrender.com/api/v1/job/delete/${jobId}`,
        {
          withCredentials: true,
        }
      )
